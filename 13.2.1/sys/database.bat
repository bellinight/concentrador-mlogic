@echo off
rem Cria e restaura o banco de dados DBMercadologic
...
timeout /t 5 /nobreak >null
rem abre o PGAdmin para troca de senha do usuario postgres, por padrão da instalação do Postgresql ele vem setado com a senha "postgres"
