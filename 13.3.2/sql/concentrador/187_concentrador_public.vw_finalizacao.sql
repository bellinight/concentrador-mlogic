...
v_select_tef := '
     ...
     , dadostefdedicado.condicaopagamento AS dfcondicao_pagto_tef
...
v_select_venda := CONCAT(v_select_comum, '
     ...
     , CASE WHEN (dadostefdedicado.codigo_ident_carteira_digital IS NOT NULL) THEN
         SUBSTRING(dadostefdedicado.codigo_ident_carteira_digital, 5, 8)
       ELSE
         pagamentotef.bandeira
       END AS dfcod_bandeira
