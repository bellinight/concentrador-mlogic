...
DROP FUNCTION IF EXISTS public.function_nfce_rj;
CREATE OR REPLACE FUNCTION public.function_nfce_rj(p_idcupomfiscal integer, p_idempresa integer) RETURNS xml AS
$BODY$
...
BEGIN  
  ...
  SELECT BTRIM(rua) AS xLgr
       ...
       , BTRIM(estado) AS UF
       , cep AS CEP
       , REGEXP_REPLACE(telefone, '\D','','g') AS fone
  ...
  -----------
    ...
    -------------------
      ...
      SELECT CASE WHEN LENGTH(novaChaveAcesso::VARCHAR) > 8 THEN
           ...
           , cfe.ind_intermed AS indIntermed
           , cfe.cnpj_intermed AS cnpjIntermed
           , cfe.identif_intermed_operacao AS idCadIntTran
        INTO v_cupomFiscal
        FROM public.formapagamentoefetuada fpe
           , formapagamento fp
           , cupomfiscal cf
      ...
      tag_ide := XMLCONCAT(tag_ide, XMLFOREST(v_cupomFiscal.indIntermed AS "indIntermed")); --[0: Sem intermediador; 1: Com Intermediador (Ver tag infIntermed)]
      ...
      THEN
        ...
        THEN
            ...
            IF (v_cliente.cMun IS NULL OR v_cliente.cMun::INTEGER <= 0) THEN 
              tag_enderDest := XMLCONCAT(tag_enderDest, XMLFOREST(busca_cMun(v_cliente.xMun, v_cliente.UF) AS "cMun"));
            ELSE 
          ...
          THEN
            ...
            THEN
              ...
              IF (v_dados_cliente.cMun IS NULL OR v_dados_cliente.cMun::INTEGER <= 0) THEN 
                tag_enderDest := XMLCONCAT(tag_enderDest, XMLFOREST(busca_cMun(v_dados_cliente.xMun, v_dados_cliente.UF) AS "cMun"));
              ELSE 
      ...
      LOOP        
        ...
        THEN
          ...
          tag_combo := XMLCONCAT(tag_combo, XMLFOREST('RJ' AS "UFCons"));
              ...
              ELSE
                ...
                ELSE
                  ...
                  THEN
                    ...
                    THEN
                      tag_tipo_PIS := XMLCONCAT(tag_tipo_PIS, XMLFOREST(round(v_itemcupom.totalliquido + v_det.vFrete,2) AS "vBC"));
      ...
      FOR v_pag IN   SELECT   fp.forma_pagamento_sefaz AS tPag
            ...
            ,(CASE 
              WHEN fp.forma_pagamento_sefaz IN ('01','02','05') THEN NULL
              WHEN ptef.bandeira ='00001' THEN '01'  --Visa credito
              WHEN ptef.bandeira ='20002' THEN '01'  --Visa debito
              WHEN ptef.bandeira ='10002' THEN '01'  --Visa voucher
              WHEN ptef.bandeira ='00002' THEN '02'  --MasterCard
              WHEN ptef.bandeira ='00004' THEN '03'  --American Express
              WHEN ptef.bandeira ='00015' THEN '04'  --Sorocred credito
              WHEN ptef.bandeira ='20071' THEN '04'  --Sorocred debito
              WHEN ptef.bandeira ='10037' THEN '04'  --Sorocred voucher generico
              WHEN ptef.bandeira ='10355' THEN '04'  --Sorocred voucher alimentacao
              WHEN ptef.bandeira ='10356' THEN '04'  --Sorocred voucher refeicao
              WHEN ptef.bandeira ='10370' THEN '04'  --Sorocred voucher combustivel
              WHEN ptef.bandeira ='00003' THEN '05'  --Diners Club credito
              WHEN ptef.bandeira ='10014' THEN '05'  --Diners Club voucher generico
              WHEN ptef.bandeira ='00031' THEN '06'  --Elo credito 
              WHEN ptef.bandeira ='20032' THEN '06'  --Elo debito 
              WHEN ptef.bandeira ='10082' THEN '06'  --Elo voucher combustivel
              WHEN ptef.bandeira ='00013' THEN '08'  --Aura
              WHEN ptef.bandeira ='00030' THEN '09'  --Cabal credito
              WHEN ptef.bandeira ='20003' THEN '09'  --Cabal debito
              WHEN ptef.bandeira ='20189' THEN '09'  --Cabal debito private label
              WHEN ptef.bandeira ='10012' THEN '09'  --Cabal voucher generico
              WHEN ptef.bandeira ='10270' THEN '09'  --Cabal voucher refeicao
              WHEN ptef.bandeira ='10271' THEN '09'  --Cabal voucher alimentacao
              WHEN ptef.bandeira ='10272' THEN '09'  --Cabal voucher cultura
              WHEN ptef.bandeira ='10357' THEN '09'  --Cabal gift
              WHEN ptef.bandeira ='10358' THEN '09'  --Cabal combustivel
              WHEN ptef.bandeira ='00284' THEN '10'  --Alelo credito
              WHEN ptef.bandeira ='10019' THEN '10'  --Alelo voucher generico
              WHEN ptef.bandeira ='10021' THEN '10'  --Alelo voucher refeicao
              WHEN ptef.bandeira ='10022' THEN '10'  --Alelo voucher alimentacao
              WHEN ptef.bandeira ='10023' THEN '10'  --Alelo voucher cultura
              WHEN ptef.bandeira ='10242' THEN '10'  --Alelo voucher beneficio
              WHEN ptef.bandeira ='00035' THEN '11'  --Banescard credito
              WHEN ptef.bandeira ='20036' THEN '11'  --Banescard debito
              WHEN ptef.bandeira ='00090' THEN '12'  --CalCard credito
              WHEN ptef.bandeira ='00070' THEN '13'  --Credz
              WHEN ptef.bandeira ='00476' THEN '14'  --Discover credito
              WHEN ptef.bandeira ='00130' THEN '15'  --Goodcard credito
              WHEN ptef.bandeira ='20131' THEN '15'  --Goodcard debito
              WHEN ptef.bandeira ='10132' THEN '15'  --Goodcard voucher generico
              WHEN ptef.bandeira ='10133' THEN '15'  --Goodcard voucher refeicao
              WHEN ptef.bandeira ='10134' THEN '15'  --Goodcard voucher alimentacao
              WHEN ptef.bandeira ='10135' THEN '15'  --Goodcard voucher combustivel
              WHEN ptef.bandeira ='10173' THEN '16'  --Greencard voucher alimentacao
              WHEN ptef.bandeira ='10174' THEN '16'  --Greencard voucher refeicao
              WHEN ptef.bandeira ='10175' THEN '16'  --Greencard voucher cultura
              WHEN ptef.bandeira ='00012' THEN '17'  --Hiper credito
              WHEN ptef.bandeira ='20037' THEN '17'  --Hiper debito
              WHEN ptef.bandeira ='00011' THEN '18'  --JcB credito
              WHEN ptef.bandeira ='00057' THEN '19'  --Mais (Credisystem) credito
              WHEN ptef.bandeira ='00033' THEN '21'  --Policard credito
              WHEN ptef.bandeira ='20034' THEN '21'  --Policard debito
              WHEN ptef.bandeira ='10162' THEN '21'  --Policard voucher generico
              WHEN ptef.bandeira ='10163' THEN '21'  --Policard combustivel frota 
              WHEN ptef.bandeira ='10164' THEN '21'  --Policard voucher alimentacao
              WHEN ptef.bandeira ='10165' THEN '21'  --Policard voucher refeicao
              WHEN ptef.bandeira ='10168' THEN '21'  --Policard gift
              WHEN ptef.bandeira ='10178' THEN '21'  --Policard voucher cultura
              WHEN ptef.bandeira ='10179' THEN '21'  --Policard combustivel
              WHEN ptef.bandeira ='00281' THEN '22'  --RedeCompras credito
              WHEN ptef.bandeira ='10003' THEN '23'  --Sodexo credito
              WHEN ptef.bandeira ='10028' THEN '23'  --Sodexo voucher refeicao
              WHEN ptef.bandeira ='10029' THEN '23'  --Sodexo voucher alimentação
              WHEN ptef.bandeira ='10030' THEN '23'  --Sodexo voucher gift
              WHEN ptef.bandeira ='10031' THEN '23'  --Sodexo voucher generico
              WHEN ptef.bandeira ='10032' THEN '23'  --Sodexo voucher cultura
              WHEN ptef.bandeira ='10033' THEN '23'  --Sodexo voucher combustível
              WHEN ptef.bandeira ='10269' THEN '23'  --Sodexo voucher beneficio
              WHEN ptef.bandeira ='10011' THEN '24'  --Valecard voucher generico
              WHEN ptef.bandeira ='10055' THEN '24'  --Valecard voucher cultura
              WHEN ptef.bandeira ='10237' THEN '24'  --Valecard voucher alimentacao
              WHEN ptef.bandeira ='10238' THEN '24'  --Valecard voucher refeicao
              WHEN ptef.bandeira ='20192' THEN '24'  --Valecard debito
              WHEN ptef.bandeira ='10282' THEN '24'  --Valecard nenhum
              WHEN ptef.bandeira ='00282' THEN '24'  --Valecard credito
              WHEN ptef.bandeira ='10283' THEN '24'  --Valecard combustivel
              WHEN ptef.bandeira ='10008' THEN '25'  --Verocheque voucher generico
              WHEN ptef.bandeira ='10090' THEN '25'  --Verocheque voucher cultura
              WHEN ptef.bandeira ='10176' THEN '25'  --Verocheque voucher alimentacao
              WHEN ptef.bandeira ='10177' THEN '25'  --Verocheque voucher refeicao
              WHEN ptef.bandeira ='10265' THEN '25'  --Verocheque combustivel
              WHEN ptef.bandeira ='00269' THEN '25'  --Verocheque credito
              WHEN ptef.bandeira ='10047' THEN '26'  --VR voucher refeicao
              WHEN ptef.bandeira ='10048' THEN '26'  --VR voucher alimentacao
              WHEN ptef.bandeira ='10049' THEN '26'  --VR voucher combustivel
              WHEN ptef.bandeira ='10050' THEN '26'  --VR voucher cultura
              WHEN ptef.bandeira ='10070' THEN '26'  --VR voucher beneficio
              WHEN ptef.bandeira ='10083' THEN '26'  --VR voucher generico
              WHEN ptef.bandeira ='10285' THEN '26'  --VR gift
              WHEN ptef.bandeira ='10001' THEN '27'  --Ticket voucher generico
              WHEN ptef.bandeira ='10024' THEN '27'  --Ticket voucher refeicao
              WHEN ptef.bandeira ='10025' THEN '27'  --Ticket voucher alimentacao
              WHEN ptef.bandeira ='10027' THEN '27'  --Ticket voucher cultura
              WHEN ptef.bandeira ='10054' THEN '27'  --Ticket voucher combustivel  
              WHEN ptef.bandeira ='00072' THEN '27'  --Ticket credito
              WHEN ptef.bandeira ='20076' THEN '27'  --Ticket debito
              ELSE '99'                              --Outros
             END) AS tBand
      ...
      LOOP
        ...
        IF v_pag.tPag = '99' /*OUTROS*/ THEN
           tag_det_pag_tmp := XMLCONCAT(tag_det_pag_tmp, XMLFOREST(v_pag.xPag AS "xPag"));
        END IF;
      ...
      ---------------------------------
      IF v_cupomFiscal.indIntermed  = 1 THEN
         SELECT XMLELEMENT(name "infIntermed"
              , XMLFOREST(v_cupomFiscal.cnpjIntermed AS "CNPJ")
              , XMLFOREST(v_cupomFiscal.IdCadIntTran AS "idCadIntTran"))
           INTO tag_infIntermed;
      END IF;
      ---------------------------------
      -- <NFe><infNFe></infIntermed> --
      ---------------------------------
      ...
      -------------------------------
      SELECT XMLELEMENT(name "infRespTec"
           , XMLFOREST('00779317000178' AS "CNPJ")
           , XMLFOREST('SUPORTE' AS "xContato")
           , XMLFOREST('suporte.mercadologic@processasistemas.com.br' AS "email")
           , XMLFOREST('03232288979' AS "fone"))
        INTO tag_infRespTec;
      --------------------------------
      -- <NFe><infNFe></infRespTec> --
      --------------------------------
  ...
  THEN
    SELECT XMLELEMENT(name "infNFeSupl"
         ...
         ,XMLFOREST('www.fazenda.rj.gov.br/nfce/consulta' AS "urlChave"))
      INTO tag_infNFeSupl;
  END IF;
